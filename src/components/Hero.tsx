    ...
    <section className="relative h-screen flex items-center justify-center bg-gradient-to-b from-gray-50 to-white overflow-hidden">
      <div className="container mx-auto px-6 md:px-12 lg:px-20 text-center">
        ...
        <motion.h1
          ...
          className="text-3xl md:text-5xl font-serif text-gray-800 mb-6 max-w-4xl mx-auto px-4"
        >
        ...
        <motion.p
          ...
          className="text-lg md:text-xl text-gray-600 mb-8 max-w-3xl mx-auto px-4"
        >
