      ...
      <div className="container mx-auto px-4">
        <div className="max-w-6xl mx-auto">
          ...
          >
            ...
            <h3 className="text-base md:text-lg text-gray-600 mb-6 max-w-3xl mx-auto px-4 font-noto-serif-ethiopic">
          ...
          <div className="grid lg:grid-cols-2 gap-8 items-stretch mb-16">
            ...
            >
              ...
              <Card className="border-l-4 border-l-sply-gold bg-gradient-to-r from-sply-gold/5 to-transparent transition-all duration-300 hover:shadow-lg hover:scale-105 hover:from-sply-gold/10 cursor-pointer">
                <CardContent className="p-3">
                  <div>
                    ...
                    <p className="text-gray-600 text-xs font-noto-serif-ethiopic">
              ...
              <div className="flex justify-center py-0.5">
                <ArrowRight className="w-4 h-4 text-sply-gold" />
              </div>
                ...
                <CardContent className="p-6 flex flex-col h-full">
                  ...
                  <div className="grid grid-cols-1 gap-4 mt-auto">
                    <div className="text-center p-4 bg-white/10 rounded-lg border border-white/20">
                      <div className="text-2xl font-bold text-sply-gold font-montserrat mb-1">$31M+</div>
                      <div className="text-xs text-gray-300 font-noto-serif-ethiopic uppercase tracking-wide">Purchase Orders Financed</div>
                    </div>
                    <div className="grid grid-cols-2 gap-3">
                      <div className="text-center p-4 bg-white/10 rounded-lg border border-white/20">
                        <div className="text-lg font-bold text-sply-gold font-montserrat mb-1">188</div>
                        <div className="text-xs text-gray-300 font-noto-serif-ethiopic uppercase tracking-wide">Transactions to Date</div>
                      </div>
                      <div className="text-center p-4 bg-white/10 rounded-lg border border-white/20">
                        <div className="text-lg font-bold text-sply-gold font-montserrat mb-1">83 Days</div>
