  ...
  return (
    <div className="min-h-screen bg-sply-navy flex flex-col">
      ...
      <main className="flex-grow">
        ...
        <Partners />
        <Podcast />
        <section className="container mx-auto px-4 py-12 bg-sply-gold rounded-lg my-12 text-center">
          <h2 className="text-2xl font-bold text-sply-navy mb-4">Submit a Deal</h2>
          <p className="text-sply-navy/90 mb-6">
            Have a deal we should look at? Use our form to submit the details
          </p>
          <Link to="/submit-deal">
            <Button className="bg-sply-navy hover:bg-sply-navy/90 text-sply-offwhite">
              Submit a Deal
            </Button>
          </Link>
        </section>
      ...
      <footer className="bg-sply-navy border-t border-sply-gold/20 mt-16">
        <div className="container mx-auto px-4 py-8 flex flex-col items-center space-y-4 md:flex-row md:justify-between md:space-y-0">
          <p className="text-sply-offwhite">© 2024 All rights reserved</p>
          <Link to="/auth" className="text-sply-gold hover:text-sply-gold/80 font-semibold">
            LP LOGIN
          </Link>
        </div>
